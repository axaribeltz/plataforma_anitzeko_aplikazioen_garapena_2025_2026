...
public class AusazkoFitxategiak {
	...
	public static void main(String[] args) {
        ...
        try (RandomAccessFile raf = new RandomAccessFile("C:\\Users\\2AM3-4\\Documents\\plataforma_anitzeko_aplikazioen_garapena_2025_2026\\Datu_Atzipen_Ariketak_2025_2026\\Fitxategi Mota Batzuen Adibidea\\RandomAccessAdibidea\\datuak.dat", "rw")) {
            ...
            // 10 byte idatzi
            //MODUZ hartu esaldi honetatik. ADIBIDEZ AZTERKETAN DAUKAT 54 posiziotik 60ra ASCII bitartez kodifikatutako hitz bat -> StandardCharsets.US_ASCII

            raf.writeBytes("Zer moduz!\n");
            raf.seek(54);
            String emaitza ="";
            for (int i = 54; i < 60; i++) {
                String string = new String(new byte[]{raf.readByte()}, StandardCharsets.US_ASCII);
                emaitza += string;
            }
