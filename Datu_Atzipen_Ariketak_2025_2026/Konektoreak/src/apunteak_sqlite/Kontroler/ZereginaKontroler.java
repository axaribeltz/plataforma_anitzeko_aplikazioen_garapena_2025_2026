package apunteak_sqlite.Kontroler;

import apunteak_sqlite.Bista.KontsolaBista;

public class ZereginaKontroler {
    private apunteak_sqlite.Modeloa.db.DBZeregina eredua;
    private KontsolaBista ikuspegia;

    public ZereginaKontroler(apunteak_sqlite.Modeloa.db.DBZeregina eredua, KontsolaBista ikuspegia) {
		super();
		this.eredua = eredua;
