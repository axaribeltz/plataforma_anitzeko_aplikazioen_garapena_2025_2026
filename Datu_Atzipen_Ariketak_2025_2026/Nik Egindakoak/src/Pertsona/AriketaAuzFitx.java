...
public class AriketaAuzFitx {
    ...
    private static void pertsonaGorde(Scanner irakurgailua) {
        try (RandomAccessFile raf = new RandomAccessFile("/home/axari/Documentos/plataforma_anitzeko_aplikazioen_garapena_2025_2026/Datu_Atzipen_Ariketak_2025_2026/src/Pertsona/pertsona.dat", "rw")) {
    ...
    private static void pertsonakIkusi() {
        try (RandomAccessFile raf = new RandomAccessFile("/home/axari/Documentos/plataforma_anitzeko_aplikazioen_garapena_2025_2026/Datu_Atzipen_Ariketak_2025_2026/src/Pertsona/pertsona.dat", "r")) {
            System.out.println("\n--- Pertsona Zerrenda ---");
